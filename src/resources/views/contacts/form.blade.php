    ...
    <form action="{{ url('/confirm') }}" method="POST" class="contact-form">
        ...
        <div class="form-group">
            ...
            <div class="gender-inputs">
                ...
                <label><input type="radio" name="gender" value="2" {{ old('gender', $inputs['gender'] ?? '') == '2' ? 'checked' : '' }}> 女性</label>
                <label><input type="radio" name="gender" value="3" {{ old('gender', $inputs['gender'] ?? '') == '3' ? 'checked' : '' }}> その他</label>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="tel-inputs">
                ...
                <span>-</span>
                <input type="text" name="tel_second" maxlength="5" value="{{ old('tel_second',$inputs['tel_second'] ?? '') }}" placeholder="1234">
                <span>-</span>
                <input type="text" name="tel_third" maxlength="5" value="{{ old('tel_third',$inputs['tel_third'] ?? '') }}" placeholder="5678">
            </div>
